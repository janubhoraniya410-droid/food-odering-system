...
<div class="overlay">
  <div class="register-box neumorphic neumorphic-card">
    <h2 class="main-heading" style="margin-bottom: 30px;">Register</h2>
    ...
    <form action="regi_code.php" method="post">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="password" name="password" id="password" class="neumorphic-input" required>
        </div>
        <div class="form-group">
          <label for="cpassword">Confirm Password</label>
          <input type="password" name="cpassword" id="cpassword" class="neumorphic-input" required>
        </div>
      </div>

      <button type="submit" name="regi" class="neumorphic-button">Create your account</button>
    </form>
